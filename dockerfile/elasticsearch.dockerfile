...
ARG ELASTICSEARCH_SUDACHI_URL="https://github.com/WorksApplications/elasticsearch-sudachi/releases/download/v7.7.0-2.0.1/analysis-sudachi-elasticsearch7.7-2.0.1.zip"
ARG SUDACHI_DICT_VERSION="20200330"
